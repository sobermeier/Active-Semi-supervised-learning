...
AL_ALGORITHMS = Register('al_algorithms')
...
ALL_MODULES = [
    ...
    ('semilearn.al_algorithms', ['random', 'entropy', 'margin', 'leastconfidence', 'kcenter', 'kmeans', 'badge', 'coreset', 'powermargin', 'falcun', 'cdal', 'alphamix', 'typiclust', 'bal', 'anchoral'])
]
