...
mean, std = {}, {}
mean['wikichurch'] = [0.485, 0.456, 0.406]
std['wikichurch'] = [0.229, 0.224, 0.225]

def get_wikichurch(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True, lb_index=None, ulb_index=None, no_labels = False):
	...
	transform_weak = transforms.Compose([
		...
		transforms.ToTensor(),
		transforms.Normalize(mean['wikichurch'], std['wikichurch'])
	])
	...
	data_dir = os.path.join(data_dir, "wc14_split")
