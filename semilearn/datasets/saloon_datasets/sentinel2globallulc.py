...
mean, std = {}, {}
mean['sentinel2globallulc'] = [0.485, 0.456, 0.406]
std['sentinel2globallulc'] = [0.229, 0.224, 0.225]

def get_sentinel2globallulc(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True, lb_index=None, ulb_index=None, no_labels = False):
	...
	transform_weak = transforms.Compose([
		...
		transforms.ToTensor(),
		transforms.Normalize(mean['sentinel2globallulc'], std['sentinel2globallulc'])
	])
	...
	data_dir = os.path.join(data_dir, "Sentinel2LULC_split")
