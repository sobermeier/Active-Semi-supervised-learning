...
mean, std = {}, {}
mean['species196'] = [0.485, 0.456, 0.406]
std['species196'] = [0.229, 0.224, 0.225]

def get_species196(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True, lb_index=None, ulb_index=None, no_labels = False):
	...
	transform_weak = transforms.Compose([
		...
		transforms.ToTensor(),
		transforms.Normalize(mean['species196'], std['species196'])
	])
	...
	data_dir = os.path.join(data_dir, "species196")
	...
	print("eval")
	eval_dset = SaloonDataset(root=os.path.join(data_dir, f"val"), transform=transform_val, alg=alg, ulb=False)
