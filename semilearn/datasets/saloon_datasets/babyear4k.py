...
mean, std = {}, {}
mean['babyear4k'] = [0.485, 0.456, 0.406]
std['babyear4k'] = [0.229, 0.224, 0.225]

def get_babyear4k(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True, lb_index=None, ulb_index=None, no_labels = False):
	...
	transform_weak = transforms.Compose([
		...
		transforms.ToTensor(),
		transforms.Normalize(mean['babyear4k'], std['babyear4k'])
	])
	...
	data_dir = os.path.join(data_dir, "babyear4k_split")
