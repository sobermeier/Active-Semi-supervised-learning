...
def get_cifar(args, alg, name, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True, lb_index=None, ulb_index=None):
	...
	print("lb data", len(lb_data), flush=True)
	...
	#print("lb_len", len(lb_dset), flush=True)
